class Codegent < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/codegent-dev/cli-releases/releases/download/v0.0.10/codegent-darwin-arm64"
      sha256 "447330c2c2444158aa9460da819ea050df5b82e10735e93cc2ad90e546dc9172"
    else
      url "https://github.com/codegent-dev/cli-releases/releases/download/v0.0.10/codegent-darwin-x64"
